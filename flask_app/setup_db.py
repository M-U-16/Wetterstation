...
def setUp(path):
    ...
    cursor = con.cursor()
    cursor.execute("CREATE TABLE wetterdaten (entry_id INTEGER PRIMARY KEY AUTOINCREMENT, full_date TEXT, entry_year INT, entry_month TEXT, entry_day INT, entry_day_text TEXT, entry_time TEXT, temp INT, humi INT, pres INT, lux INT)")
    con.close()
